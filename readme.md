...
This is a continuation from [this guide](https://github.com/JasLinnie/portfolio/blob/master/README.md). Before you start on this, your application should have at least one page with a HTML form and a POST route that handles the submission of the form.  
